...
- The vendor **documents themselves are not reproduced**: no document text,
  descriptions, layout, or artwork are included — only the transcribed
  register facts, restructured into this project's own JSON/CSV/YAML schema.
